...
static int dispatch_per_machine(const char *name, sd_json_variant *variant, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        static const sd_json_dispatch_t per_machine_dispatch_table[] = {
                ...
                { "gid",            SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uid_gid,          offsetof(GroupRecord, gid),            0         },
                { "members",        SD_JSON_VARIANT_ARRAY,         sd_json_dispatch_user_group_list,  offsetof(GroupRecord, members),        SD_JSON_RELAX},
                { "administrators", SD_JSON_VARIANT_ARRAY,         sd_json_dispatch_user_group_list,  offsetof(GroupRecord, administrators), SD_JSON_RELAX},
                {},
        };
...
int group_record_load(
        ...
        static const sd_json_dispatch_t group_dispatch_table[] = {
                { "groupName",      SD_JSON_VARIANT_STRING,   sd_json_dispatch_user_group_name,  offsetof(GroupRecord, group_name),       SD_JSON_RELAX},
                { "realm",          SD_JSON_VARIANT_STRING,   sd_json_dispatch_realm,            offsetof(GroupRecord, realm),            0         },
                { "description",    SD_JSON_VARIANT_STRING,   sd_json_dispatch_gecos,            offsetof(GroupRecord, description),      0         },
                { "disposition",    SD_JSON_VARIANT_STRING,   sd_json_dispatch_user_disposition, offsetof(GroupRecord, disposition),      0         },
                { "service",        SD_JSON_VARIANT_STRING,   sd_json_dispatch_string,           offsetof(GroupRecord, service),          SD_JSON_SAFE },
                { "lastChangeUSec", SD_JSON_VARIANT_UNSIGNED, sd_json_dispatch_uint64,           offsetof(GroupRecord, last_change_usec), 0         },
                { "gid",            SD_JSON_VARIANT_UNSIGNED, sd_json_dispatch_uid_gid,          offsetof(GroupRecord, gid),              0         },
                { "members",        SD_JSON_VARIANT_ARRAY,    sd_json_dispatch_user_group_list,  offsetof(GroupRecord, members),          SD_JSON_RELAX},
                { "administrators", SD_JSON_VARIANT_ARRAY,    sd_json_dispatch_user_group_list,  offsetof(GroupRecord, administrators),   SD_JSON_RELAX},
        ...
        r = sd_json_dispatch(h->json, group_dispatch_table, NULL, json_flags, h);
        if (r < 0)
                return r;

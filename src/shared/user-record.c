...
static int sd_json_dispatch_nice(const char *name, sd_json_variant *variant, sd_json_dispatch_flags_t flags, void *userdata) {
        int *nl = userdata;
        int64_t m;
...
static int sd_json_dispatch_rlimit_value(const char *name, sd_json_variant *variant, sd_json_dispatch_flags_t flags, void *userdata) {
        rlim_t *ret = userdata;
...
static int sd_json_dispatch_rlimits(const char *name, sd_json_variant *variant, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        SD_JSON_VARIANT_OBJECT_FOREACH(key, value, variant) {
                ...
                r = sd_json_dispatch_rlimit_value("cur", jcur, flags, &rl.rlim_cur);
                if (r < 0)
                        return r;
                ...
                r = sd_json_dispatch_rlimit_value("max", jmax, flags, &rl.rlim_max);
                if (r < 0)
                        return r;
...
static int sd_json_dispatch_filename_or_path(const char *name, sd_json_variant *variant, sd_json_dispatch_flags_t flags, void *userdata) {
        char **s = userdata;
        const char *n;
        int r;
...
static int sd_json_dispatch_path(const char *name, sd_json_variant *variant, sd_json_dispatch_flags_t flags, void *userdata) {
        char **s = userdata;
        const char *n;
        int r;
...
static int sd_json_dispatch_home_directory(const char *name, sd_json_variant *variant, sd_json_dispatch_flags_t flags, void *userdata) {
        char **s = userdata;
        const char *n;
        int r;
...
static int sd_json_dispatch_image_path(const char *name, sd_json_variant *variant, sd_json_dispatch_flags_t flags, void *userdata) {
        char **s = userdata;
        const char *n;
        int r;
...
static int sd_json_dispatch_umask(const char *name, sd_json_variant *variant, sd_json_dispatch_flags_t flags, void *userdata) {
        mode_t *m = userdata;
        uint64_t k;
...
static int sd_json_dispatch_access_mode(const char *name, sd_json_variant *variant, sd_json_dispatch_flags_t flags, void *userdata) {
        mode_t *m = userdata;
        uint64_t k;
...
static int sd_json_dispatch_environment(const char *name, sd_json_variant *variant, sd_json_dispatch_flags_t flags, void *userdata) {
...
int sd_json_dispatch_user_disposition(const char *name, sd_json_variant *variant, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        k = user_disposition_from_string(sd_json_variant_string(variant));
        if (k < 0)
                return json_log(variant, flags, k, "Disposition type '%s' not known.", sd_json_variant_string(variant));

        *disposition = k;
        return 0;
}

static int sd_json_dispatch_storage(const char *name, sd_json_variant *variant, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        k = user_storage_from_string(sd_json_variant_string(variant));
        if (k < 0)
                return json_log(variant, flags, k, "Storage type '%s' not known.", sd_json_variant_string(variant));

        *storage = k;
        return 0;
}

static int sd_json_dispatch_tasks_or_memory_max(const char *name, sd_json_variant *variant, sd_json_dispatch_flags_t flags, void *userdata) {
...
static int sd_json_dispatch_weight(const char *name, sd_json_variant *variant, sd_json_dispatch_flags_t flags, void *userdata) {
...
int sd_json_dispatch_user_group_list(const char *name, sd_json_variant *variant, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        SD_JSON_VARIANT_ARRAY_FOREACH(e, variant) {
...
static int dispatch_secret(const char *name, sd_json_variant *variant, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        static const sd_json_dispatch_t secret_dispatch_table[] = {
        ...
        return sd_json_dispatch(variant, secret_dispatch_table, NULL, flags, userdata);
}
...
static int dispatch_pkcs11_key_data(const char *name, sd_json_variant *variant, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        r = unbase64mem(sd_json_variant_string(variant), SIZE_MAX, &b, &l);
        if (r < 0)
...
static int dispatch_pkcs11_key(const char *name, sd_json_variant *variant, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        SD_JSON_VARIANT_ARRAY_FOREACH(e, variant) {
                ...
                static const sd_json_dispatch_t pkcs11_key_dispatch_table[] = {
                ...
                *k = (Pkcs11EncryptedKey) {};
                ...
                r = sd_json_dispatch(e, pkcs11_key_dispatch_table, NULL, flags, k);
                if (r < 0) {
...
static int dispatch_fido2_hmac_credential_array(const char *name, sd_json_variant *variant, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        SD_JSON_VARIANT_ARRAY_FOREACH(e, variant) {
                ...
                r = unbase64mem(sd_json_variant_string(e), SIZE_MAX, &b, &l);
                if (r < 0)
                        return json_log(variant, flags, r, "Failed to decode FIDO2 credential ID: %m");
...
static int dispatch_fido2_hmac_salt(const char *name, sd_json_variant *variant, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        SD_JSON_VARIANT_ARRAY_FOREACH(e, variant) {
                ...
                static const sd_json_dispatch_t fido2_hmac_salt_dispatch_table[] = {
                ...
                *k = (Fido2HmacSalt) {
                ...
                r = sd_json_dispatch(e, fido2_hmac_salt_dispatch_table, NULL, flags, k);
                if (r < 0) {
...
static int dispatch_recovery_key(const char *name, sd_json_variant *variant, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        SD_JSON_VARIANT_ARRAY_FOREACH(e, variant) {
                ...
                static const sd_json_dispatch_t recovery_key_dispatch_table[] = {
                ...
                *k = (RecoveryKey) {};
                ...
                r = sd_json_dispatch(e, recovery_key_dispatch_table, NULL, flags, k);
                if (r < 0) {
                        recovery_key_done(k);
                        return r;
                }
...
static int dispatch_privileged(const char *name, sd_json_variant *variant, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        static const sd_json_dispatch_t privileged_dispatch_table[] = {
        ...
        return sd_json_dispatch(variant, privileged_dispatch_table, NULL, flags, userdata);
}

static int dispatch_binding(const char *name, sd_json_variant *variant, sd_json_dispatch_flags_t flags, void *userdata) {

        static const sd_json_dispatch_t binding_dispatch_table[] = {
                { "imagePath",         SD_JSON_VARIANT_STRING,        sd_json_dispatch_image_path,     offsetof(UserRecord, image_path),           0         },
                { "homeDirectory",     SD_JSON_VARIANT_STRING,        sd_json_dispatch_home_directory, offsetof(UserRecord, home_directory),       0         },
                ...
                { "storage",           SD_JSON_VARIANT_STRING,        sd_json_dispatch_storage,        offsetof(UserRecord, storage),              0         },
                ...
                { "luksVolumeKeySize", SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uint64,         offsetof(UserRecord, luks_volume_key_size), 0         },
                {},
        };
        ...
        return sd_json_dispatch(m, binding_dispatch_table, NULL, flags, userdata);
}
...
int per_machine_id_match(sd_json_variant *ids, sd_json_dispatch_flags_t flags) {
        ...
        if (sd_json_variant_is_array(ids)) {
                ...
                SD_JSON_VARIANT_ARRAY_FOREACH(e, ids) {
                        sd_id128_t k;
...
int per_machine_hostname_match(sd_json_variant *hns, sd_json_dispatch_flags_t flags) {
        ...
        if (sd_json_variant_is_array(hns)) {
                ...
                SD_JSON_VARIANT_ARRAY_FOREACH(e, hns) {
...
static int dispatch_per_machine(const char *name, sd_json_variant *variant, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        static const sd_json_dispatch_t per_machine_dispatch_table[] = {
                ...
                { "shell",                      SD_JSON_VARIANT_STRING,        sd_json_dispatch_filename_or_path,       offsetof(UserRecord, shell),                         0         },
                { "umask",                      SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_umask,                  offsetof(UserRecord, umask),                         0         },
                { "environment",                SD_JSON_VARIANT_ARRAY,         sd_json_dispatch_environment,            offsetof(UserRecord, environment),                   0         },
                { "timeZone",                   SD_JSON_VARIANT_STRING,        sd_json_dispatch_string,                 offsetof(UserRecord, time_zone),                     SD_JSON_SAFE },
                { "preferredLanguage",          SD_JSON_VARIANT_STRING,        sd_json_dispatch_string,                 offsetof(UserRecord, preferred_language),            SD_JSON_SAFE },
                { "niceLevel",                  _SD_JSON_VARIANT_TYPE_INVALID, sd_json_dispatch_nice,                   offsetof(UserRecord, nice_level),                    0         },
                { "resourceLimits",             _SD_JSON_VARIANT_TYPE_INVALID, sd_json_dispatch_rlimits,                offsetof(UserRecord, rlimits),                       0         },
                { "locked",                     SD_JSON_VARIANT_BOOLEAN,       sd_json_dispatch_tristate,               offsetof(UserRecord, locked),                        0         },
                { "notBeforeUSec",              SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uint64,                 offsetof(UserRecord, not_before_usec),               0         },
                { "notAfterUSec",               SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uint64,                 offsetof(UserRecord, not_after_usec),                0         },
                { "storage",                    SD_JSON_VARIANT_STRING,        sd_json_dispatch_storage,                offsetof(UserRecord, storage),                       0         },
                { "diskSize",                   SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uint64,                 offsetof(UserRecord, disk_size),                     0         },
                { "diskSizeRelative",           SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uint64,                 offsetof(UserRecord, disk_size_relative),            0         },
                { "skeletonDirectory",          SD_JSON_VARIANT_STRING,        sd_json_dispatch_path,                   offsetof(UserRecord, skeleton_directory),            0         },
                { "accessMode",                 SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_access_mode,            offsetof(UserRecord, access_mode),                   0         },
                { "tasksMax",                   SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_tasks_or_memory_max,    offsetof(UserRecord, tasks_max),                     0         },
                { "memoryHigh",                 SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_tasks_or_memory_max,    offsetof(UserRecord, memory_high),                   0         },
                { "memoryMax",                  SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_tasks_or_memory_max,    offsetof(UserRecord, memory_max),                    0         },
                { "cpuWeight",                  SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_weight,                 offsetof(UserRecord, cpu_weight),                    0         },
                { "ioWeight",                   SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_weight,                 offsetof(UserRecord, io_weight),                     0         },
                { "mountNoDevices",             SD_JSON_VARIANT_BOOLEAN,       sd_json_dispatch_boolean,                offsetof(UserRecord, nodev),                         0         },
                { "mountNoSuid",                SD_JSON_VARIANT_BOOLEAN,       sd_json_dispatch_boolean,                offsetof(UserRecord, nosuid),                        0         },
                { "mountNoExecute",             SD_JSON_VARIANT_BOOLEAN,       sd_json_dispatch_boolean,                offsetof(UserRecord, noexec),                        0         },
                ...
                { "imagePath",                  SD_JSON_VARIANT_STRING,        sd_json_dispatch_path,                   offsetof(UserRecord, image_path),                    0         },
                { "uid",                        SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uid_gid,                offsetof(UserRecord, uid),                           0         },
                { "gid",                        SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uid_gid,                offsetof(UserRecord, gid),                           0         },
                { "memberOf",                   SD_JSON_VARIANT_ARRAY,         sd_json_dispatch_user_group_list,        offsetof(UserRecord, member_of),                     SD_JSON_RELAX},
                { "fileSystemType",             SD_JSON_VARIANT_STRING,        sd_json_dispatch_string,                 offsetof(UserRecord, file_system_type),              SD_JSON_SAFE },
                { "partitionUuid",              SD_JSON_VARIANT_STRING,        sd_json_dispatch_id128,                  offsetof(UserRecord, partition_uuid),                0         },
                { "luksUuid",                   SD_JSON_VARIANT_STRING,        sd_json_dispatch_id128,                  offsetof(UserRecord, luks_uuid),                     0         },
                { "fileSystemUuid",             SD_JSON_VARIANT_STRING,        sd_json_dispatch_id128,                  offsetof(UserRecord, file_system_uuid),              0         },
                ...
                { "luksPbkdfTimeCostUSec",      SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uint64,                 offsetof(UserRecord, luks_pbkdf_time_cost_usec),     0         },
                { "luksPbkdfMemoryCost",        SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uint64,                 offsetof(UserRecord, luks_pbkdf_memory_cost),        0         },
                { "luksPbkdfParallelThreads",   SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uint64,                 offsetof(UserRecord, luks_pbkdf_parallel_threads),   0         },
                ...
                { "rateLimitIntervalUSec",      SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uint64,                 offsetof(UserRecord, ratelimit_interval_usec),       0         },
                { "rateLimitBurst",             SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uint64,                 offsetof(UserRecord, ratelimit_burst),               0         },
                ...
                { "stopDelayUSec",              SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uint64,                 offsetof(UserRecord, stop_delay_usec),               0         },
                { "killProcesses",              SD_JSON_VARIANT_BOOLEAN,       sd_json_dispatch_tristate,               offsetof(UserRecord, kill_processes),                0         },
                { "passwordChangeMinUSec",      SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uint64,                 offsetof(UserRecord, password_change_min_usec),      0         },
                { "passwordChangeMaxUSec",      SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uint64,                 offsetof(UserRecord, password_change_max_usec),      0         },
                { "passwordChangeWarnUSec",     SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uint64,                 offsetof(UserRecord, password_change_warn_usec),     0         },
                { "passwordChangeInactiveUSec", SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uint64,                 offsetof(UserRecord, password_change_inactive_usec), 0         },
        ...
        SD_JSON_VARIANT_ARRAY_FOREACH(e, variant) {
                ...
                m = sd_json_variant_by_key(e, "matchMachineId");
                if (m) {
                ...
                if (!matching) {
                        m = sd_json_variant_by_key(e, "matchHostname");
                        if (m) {
                ...
                r = sd_json_dispatch(e, per_machine_dispatch_table, NULL, flags, userdata);
                if (r < 0)
                        return r;
        }
...
static int dispatch_status(const char *name, sd_json_variant *variant, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        static const sd_json_dispatch_t status_dispatch_table[] = {
                { "diskUsage",                  SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uint64,      offsetof(UserRecord, disk_usage),                    0         },
                { "diskFree",                   SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uint64,      offsetof(UserRecord, disk_free),                     0         },
                { "diskSize",                   SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uint64,      offsetof(UserRecord, disk_size),                     0         },
                { "diskCeiling",                SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uint64,      offsetof(UserRecord, disk_ceiling),                  0         },
                { "diskFloor",                  SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uint64,      offsetof(UserRecord, disk_floor),                    0         },
                ...
                { "goodAuthenticationCounter",  SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uint64,      offsetof(UserRecord, good_authentication_counter),   0         },
                { "badAuthenticationCounter",   SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uint64,      offsetof(UserRecord, bad_authentication_counter),    0         },
                { "lastGoodAuthenticationUSec", SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uint64,      offsetof(UserRecord, last_good_authentication_usec), 0         },
                { "lastBadAuthenticationUSec",  SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uint64,      offsetof(UserRecord, last_bad_authentication_usec),  0         },
                { "rateLimitBeginUSec",         SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uint64,      offsetof(UserRecord, ratelimit_begin_usec),          0         },
                { "rateLimitCount",             SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uint64,      offsetof(UserRecord, ratelimit_count),               0         },
                { "removable",                  SD_JSON_VARIANT_BOOLEAN,       sd_json_dispatch_boolean,     offsetof(UserRecord, removable),                     0         },
                { "accessMode",                 SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_access_mode, offsetof(UserRecord, access_mode),                   0         },
                { "fileSystemType",             SD_JSON_VARIANT_STRING,        sd_json_dispatch_string,      offsetof(UserRecord, file_system_type),              SD_JSON_SAFE },
                {},
        };
        ...
        return sd_json_dispatch(m, status_dispatch_table, NULL, flags, userdata);
}
...
int user_group_record_mangle(
        ...
        sd_json_dispatch_flags_t json_flags = USER_RECORD_LOAD_FLAGS_TO_sd_json_dispatch_FLAGS(load_flags);
...
int user_record_load(UserRecord *h, sd_json_variant *v, UserRecordLoadFlags load_flags) {
        ...
        static const sd_json_dispatch_t user_dispatch_table[] = {
                { "userName",                   SD_JSON_VARIANT_STRING,        sd_json_dispatch_user_group_name,        offsetof(UserRecord, user_name),                     SD_JSON_RELAX},
                { "realm",                      SD_JSON_VARIANT_STRING,        sd_json_dispatch_realm,                  offsetof(UserRecord, realm),                         0         },
                { "realName",                   SD_JSON_VARIANT_STRING,        sd_json_dispatch_gecos,                  offsetof(UserRecord, real_name),                     0         },
                { "emailAddress",               SD_JSON_VARIANT_STRING,        sd_json_dispatch_string,                 offsetof(UserRecord, email_address),                 SD_JSON_SAFE },
                { "iconName",                   SD_JSON_VARIANT_STRING,        sd_json_dispatch_string,                 offsetof(UserRecord, icon_name),                     SD_JSON_SAFE },
                { "location",                   SD_JSON_VARIANT_STRING,        sd_json_dispatch_string,                 offsetof(UserRecord, location),                      0         },
                { "disposition",                SD_JSON_VARIANT_STRING,        sd_json_dispatch_user_disposition,       offsetof(UserRecord, disposition),                   0         },
                { "lastChangeUSec",             SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uint64,                 offsetof(UserRecord, last_change_usec),              0         },
                { "lastPasswordChangeUSec",     SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_uint64,                 offsetof(UserRecord, last_password_change_usec),     0         },
                { "shell",                      SD_JSON_VARIANT_STRING,        sd_json_dispatch_filename_or_path,       offsetof(UserRecord, shell),                         0         },
                { "umask",                      SD_JSON_VARIANT_UNSIGNED,      sd_json_dispatch_umask,                  offsetof(UserRecord, umask),                         0         },
                { "environment",                SD_JSON_VARIANT_ARRAY,         sd_json_dispatch_environment,            offsetof(UserRecord, environment),                   0         },
                { "timeZone",                   SD_JSON_VARIANT_STRING,        sd_json_dispatch_string,                 offsetof(UserRecord, time_zone),                     SD_JSON_SAFE },
        ...
        r = sd_json_dispatch(h->json, user_dispatch_table, NULL, json_flags, h);
        if (r < 0)
                return r;

...
static int oci_console_size(const char *name, sd_json_variant *v, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        static const sd_json_dispatch_t table[] = {
        ...
        return sd_json_dispatch(v, table, oci_unexpected, flags, userdata);
}

static int oci_absolute_path(const char *name, sd_json_variant *v, sd_json_dispatch_flags_t flags, void *userdata) {
        char **p = userdata;
        const char *n;

        assert(p);

        n = sd_json_variant_string(v);
...
static int oci_env(const char *name, sd_json_variant *v, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        SD_JSON_VARIANT_ARRAY_FOREACH(e, v) {
                const char *n;
...
static int oci_rlimits(const char *name, sd_json_variant *v, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        SD_JSON_VARIANT_ARRAY_FOREACH(e, v) {
                ...
                r = sd_json_dispatch(e, table, oci_unexpected, flags, &data);
                if (r < 0)
                        return r;
...
static int oci_capabilities(const char *name, sd_json_variant *v, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        r = sd_json_dispatch(v, table, oci_unexpected, flags, &s->full_capabilities);
        if (r < 0)
                return r;
...
static int oci_uid_gid(const char *name, sd_json_variant *v, sd_json_dispatch_flags_t flags, void *userdata) {
...
static int oci_user(const char *name, sd_json_variant *v, sd_json_dispatch_flags_t flags, void *userdata) {
        static const sd_json_dispatch_t table[] = {
                { "uid",            SD_JSON_VARIANT_UNSIGNED, oci_uid_gid,            offsetof(Settings, uid), SD_JSON_MANDATORY },
                { "gid",            SD_JSON_VARIANT_UNSIGNED, oci_uid_gid,            offsetof(Settings, gid), SD_JSON_MANDATORY },
...
static int oci_process(const char *name, sd_json_variant *v, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        static const sd_json_dispatch_t table[] = {
                ...
                { "cwd",             SD_JSON_VARIANT_STRING,  oci_absolute_path,     offsetof(Settings, working_directory), 0               },
                ...
                { "noNewPrivileges", SD_JSON_VARIANT_BOOLEAN, sd_json_dispatch_boolean, offsetof(Settings, no_new_privileges), 0               },
...
static int oci_root(const char *name, sd_json_variant *v, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        static const sd_json_dispatch_t table[] = {
                ...
                { "readonly", SD_JSON_VARIANT_BOOLEAN, sd_json_dispatch_boolean, offsetof(Settings, read_only) },
                {}
        };

        r = sd_json_dispatch(v, table, oci_unexpected, flags, s);
        if (r < 0)
                return r;
...
static int oci_mounts(const char *name, sd_json_variant *v, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        SD_JSON_VARIANT_ARRAY_FOREACH(e, v) {
                static const sd_json_dispatch_t table[] = {
                        { "destination", SD_JSON_VARIANT_STRING, oci_absolute_path,    offsetof(oci_mount_data, destination), SD_JSON_MANDATORY },
...
static int oci_namespaces(const char *name, sd_json_variant *v, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        SD_JSON_VARIANT_ARRAY_FOREACH(e, v) {
                ...
                static const sd_json_dispatch_t table[] = {
                        ...
                        { "path", SD_JSON_VARIANT_STRING, oci_absolute_path,  offsetof(struct namespace_data, path), 0              },
                        {}
                };
...
static int oci_uid_gid_mappings(const char *name, sd_json_variant *v, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        static const sd_json_dispatch_t table[] = {
                { "containerID", SD_JSON_VARIANT_UNSIGNED, oci_uid_gid,       offsetof(struct mapping_data, container_id), SD_JSON_MANDATORY },
                { "hostID",      SD_JSON_VARIANT_UNSIGNED, oci_uid_gid,       offsetof(struct mapping_data, host_id),      SD_JSON_MANDATORY },
...
static int oci_devices(const char *name, sd_json_variant *v, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        SD_JSON_VARIANT_ARRAY_FOREACH(e, v) {
                ...
                static const sd_json_dispatch_t table[] = {
                        ...
                        { "path",     SD_JSON_VARIANT_STRING,   oci_absolute_path,    offsetof(DeviceNode, path),  SD_JSON_MANDATORY },
                        ...
                        { "uid",      SD_JSON_VARIANT_UNSIGNED, oci_uid_gid,          offsetof(DeviceNode, uid),   0              },
                        { "gid",      SD_JSON_VARIANT_UNSIGNED, oci_uid_gid,          offsetof(DeviceNode, gid),   0              },
                        {}
                };
                ...
                *node = (DeviceNode) {
                ...
                r = sd_json_dispatch(e, table, oci_unexpected, flags, node);
                if (r < 0)
                        goto fail_element;
                ...
                if (S_ISCHR(node->mode) || S_ISBLK(node->mode)) {
                        ...
                        if (r < 0)
                                json_log(e, flags|SD_JSON_DEBUG, 0, "Failed to resolve device node %u:%u, ignoring: %m", node->major, node->minor);
                        else {
                                if (PATH_IN_SET(path,
                                                "/dev/null",
                                                "/dev/zero",
...
static int oci_cgroup_devices(const char *name, sd_json_variant *v, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        SD_JSON_VARIANT_ARRAY_FOREACH(e, v) {
                ...
                static const sd_json_dispatch_t table[] = {
                        { "allow",  SD_JSON_VARIANT_BOOLEAN,  sd_json_dispatch_boolean,    offsetof(struct device_data, allow), SD_JSON_MANDATORY },
...
static int oci_cgroup_memory(const char *name, sd_json_variant *v, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        static const sd_json_dispatch_t table[] = {
                ...
                { "disableOOMKiller", SD_JSON_VARIANT_NUMBER, oci_unsupported,         0,                                         SD_JSON_PERMISSIVE },
                {}
        };
        ...
        r = sd_json_dispatch(v, table, oci_unexpected, flags, &data);
        if (r < 0)
                return r;
...
static int oci_cgroup_pids(const char *name, sd_json_variant *v, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        r = sd_json_dispatch(v, table, oci_unexpected, flags, &k);
        if (r < 0)
                return r;
...
static int oci_sysctl(const char *name, sd_json_variant *v, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        SD_JSON_VARIANT_OBJECT_FOREACH(k, w, v) {
                const char *m;
...
static int oci_seccomp_args(const char *name, sd_json_variant *v, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        SD_JSON_VARIANT_ARRAY_FOREACH(e, v) {
                static const struct sd_json_dispatch_t table[] = {
                ...
                *p = (struct scmp_arg_cmp) {
                ...
                r = sd_json_dispatch(e, table, oci_unexpected, flags, p);
                if (r < 0)
                        return r;

                expected = p->op == SCMP_CMP_MASKED_EQ ? 4 : 3;
                if (r != expected)
                        json_log(e, flags|SD_JSON_WARNING, 0, "Wrong number of system call arguments for JSON data data, ignoring.");
...
static int oci_seccomp_syscalls(const char *name, sd_json_variant *v, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        SD_JSON_VARIANT_ARRAY_FOREACH(e, v) {
                ...
                r = sd_json_dispatch(e, table, oci_unexpected, flags, &rule);
                if (r < 0)
                        goto fail_rule;
...
static int oci_seccomp(const char *name, sd_json_variant *v, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        r = sd_json_dispatch(v, table, oci_unexpected, flags, sc);
        if (r < 0)
                return r;
...
static int oci_hooks_array(const char *name, sd_json_variant *v, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        SD_JSON_VARIANT_ARRAY_FOREACH(e, v) {
                ...
                static const sd_json_dispatch_t table[] = {
                        { "path",    SD_JSON_VARIANT_STRING,   oci_absolute_path, offsetof(OciHook, path),    SD_JSON_MANDATORY },
                ...
                *new_item = (OciHook) {
                ...
                r = sd_json_dispatch(e, table, oci_unexpected, flags, userdata);
                if (r < 0) {
                        free(new_item->path);
...
static int oci_hooks(const char *name, sd_json_variant *v, sd_json_dispatch_flags_t flags, void *userdata) {
        ...
        static const sd_json_dispatch_t table[] = {
                { "prestart",  SD_JSON_VARIANT_OBJECT, oci_hooks_array, 0, 0 },
                { "poststart", SD_JSON_VARIANT_OBJECT, oci_hooks_array, 0, 0 },
                { "poststop",  SD_JSON_VARIANT_OBJECT, oci_hooks_array, 0, 0 },
                {}
        };
...
int oci_load(FILE *f, const char *bundle, Settings **ret) {
        ...
        //         assert_se(sd_json_variant_format(oci, SD_JSON_FORMAT_PRETTY|SD_JSON_FORMAT_COLOR, &formatted) >= 0);
        ...
        r = sd_json_dispatch(oci, table, oci_unexpected, 0, s);
        if (r < 0)
                return r;

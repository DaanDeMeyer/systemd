...
int enroll_pkcs11(
        ...
        r = sd_json_build(&v,
                       SD_JSON_BUILD_OBJECT(
                                       SD_JSON_BUILD_PAIR("type", SD_JSON_BUILD_CONST_STRING("systemd-pkcs11")),
                                       SD_JSON_BUILD_PAIR("keyslots", SD_JSON_BUILD_ARRAY(SD_JSON_BUILD_STRING(keyslot_as_string))),
                                       SD_JSON_BUILD_PAIR("pkcs11-uri", SD_JSON_BUILD_STRING(uri)),
                                       SD_JSON_BUILD_PAIR("pkcs11-key", SD_JSON_BUILD_BASE64(encrypted_key, encrypted_key_size))));
        if (r < 0)
